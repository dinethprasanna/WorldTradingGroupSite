  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        url: "/admin/documents-verification",
      },
    ],
  },
  {
        ...
        <SidebarHeader className="bg-[#030F1D] md:py-4 mb-6 lg:mb-8">
            <div className="sidebar- mt-4 md:mt-4">
                ...
                <div className="admin-info mt-3">
                  <p className="u-name text-sm text-(--dark-white)" id="admin_name">Martin Garrix</p>
                  <p className="u-email text-sm text-(--dark-white)" id="admin_email">MartinGarrix@mail.com</p>
                </div>
            </div>
        </SidebarHeader>
