...
function Sidebar({
  ...
  return (
    (<div
      ...
      <div
        className={cn(
          "fixed md:absolute inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarTrigger({
  ...
  return (
    (<Button
      ...
      {...props}>
      <PanelLeftOpen  color="#ffffff" size={32}  />
